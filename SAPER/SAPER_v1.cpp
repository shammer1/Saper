...
void	  Game_DrawStartField(int, int);//рисуем все клеточки
		  //Цикл считывания клавиатуры (выходим когда конец игры)----------------------------------------------------------------------------
...
int	/*+>*/Game_OpenCell(int, int, Cell*, int, int);//Пробел/проверка клетки(закрыта/открыта мина/не мина) и проверка на конец игры
